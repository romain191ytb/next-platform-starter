      ...
      >
        ...
        >
          <h1 style={{ fontSize: "6em", fontWeight: 800, color: "rgb(255, 255, 255)" }}>
            RÈGLEMENT DU SERVEUR - PURESIDE V RP 🚀
          </h1>
          <p style={{ fontSize: "2em", color: "rgb(255, 255, 255)" }}>Bienvenue sur Pureside V RP</p>
          <p style={{ fontSize: "1.5em", color: "rgb(255, 255, 255)" }}>
            En rejoignant Pureside V RP, vous acceptez notre règlement.
          </p>
        </div>
      </div>,
      {
